...
public class Menu extends JPanel {
	...
	private final String headerName = " Quản lý đặt vé tàu";
	...
	private final String menuItems[][] = { { "~Quản lý~" }, { "Quản lý người dùng","Quản lý hành khách","Quản lý khách hàng" }, { "Quản lý vé" },
			{ "Quản lý lịch tàu","Quản lý lịch trình","Quản lý chuyến" ,"Quản lý ghế ngồi"}, { "Quản lý tài khoản" },{"Quản lý khuyến mãi"},
			{ "~Xem chi tiết~" }, { "Hóa đơn", "Hóa đơn bán", "Hóa đơn đổi", "Hóa đơn trả" },
			{ "Tàu", "Toa tàu", "Tàu" ,"Nhà ga"} };
	...
	public void setMenuFull(boolean menuFull) {
		fp = new Font("Times new Roman", Font.BOLD, 25);
	...
	private void init() {
		...
		header.setIcon(new FlatSVGIcon(getClass().getResource("/icon/logo.svg")));
